...
Game_Action.prototype.applyDurabilityEffects = function(target) {
    if (this.subject().isActor()) {
      ...
      if(this.subject()._equips[1]&&this.subject()._equips[1]._dataClass!="weapon"){
      var shield = $dataArmors[this.subject()._equips[1]._itemId];
      if(shield&&this._item.isSkill()&&shield.meta.no_count==this._item._itemId)this.subject().damageShieldDurability(shield);
      };
