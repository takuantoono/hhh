...
Scene_CharSelect.prototype.refreshParameters = function() {
	...
	this.drawPar(this.actor().hp,xr + 10,yr + 44);
    this.drawPar(this.actor().mp,xr + 130,yr + 44);
	this.drawPar(this.actor().atk,xr + 10,yr + 87);
    this.drawPar(this.actor().def,xr + 130,yr + 87);
	this.drawPar(this.actor().mat,xr + 10,yr + 130);
    this.drawPar(this.actor().mdf,xr + 130,yr + 130);
	this.drawPar(this.actor().agi,xr + 10,yr + 173);
    this.drawPar(this.actor().luk,xr + 130,yr + 173);	
};
