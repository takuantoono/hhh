...
Window_Base.prototype.drawActorClass = function(actor, wx, wy, ww) {
    ...
    if(actor.isStateAffected(320))name=$dataStates[320].name;
    if(actor.isStateAffected(321))name=$dataStates[321].name;
    if(actor.isStateAffected(322))name=$dataStates[322].name;
    if(actor.isStateAffected(323))name=$dataStates[323].name;
    if(actor.isStateAffected(324))name=$dataStates[324].name;
    if(actor.isStateAffected(325))name=$dataStates[325].name;
    if(actor.isStateAffected(326))name=$dataStates[326].name;
    if(actor.isStateAffected(327))name=$dataStates[327].name;
    if(actor.isStateAffected(328))name=$dataStates[328].name;
    if(actor.isStateAffected(329))name=$dataStates[329].name;
...
Window_Base.prototype.specialClass = function(actor, name){
    ...
    if(actor.isStateAffected(355))name=$dataStates[355].name;
    if(actor.isStateAffected(356))name=$dataStates[356].name;
    if(actor.isStateAffected(357))name=$dataStates[357].name;
    if(actor.isStateAffected(358))name=$dataStates[358].name;
    return name;
};
